...
<body class="sidebar-fixed">
            ...
            <div class="modal-dialog modal-lg">
             ...
             <div class="modal-content">
               ...
               <div class="modal-header">
                    <h5 class="modal-title" id="exampleModalLabel">Tutorial sobre el sistema de inventarios</h5>
               ...
               <div class="modal-body">
                    <div class="row">
                        <div class="col-md-12">
                            <h4>Tutorial de como se usa el sistema de inventarios</h4>
                        ...
                        <div class="col-md-6">
                            <a href="#" class="sqr-btn">Ir al panel administrador </a>
                        </div>
                        <div class="col-md-6">
                            <p><strong>Correo: Admin@gmail.com</strong> </p>
                            <p><strong>Contraseña: 123456789</strong> </p>
                ...
                <ul class="navbar-nav navbar-nav-right">
                    ...
                    <li class="nav-item d-none d-lg-flex">
                        <a class="nav-link" href="#"  data-toggle="modal" data-target="#modalInicio">
                          <span class="btn btn-primary">Tutorial</span>
                        </a>
                    </li>
                ...
                {{-- <footer class="footer">
                    <div class="d-sm-flex justify-content-center justify-content-sm-between">
                        <span class="text-muted text-center text-sm-left d-block d-sm-inline-block">Copyright © 2022.
                            Todos los derechos reservados ADPSTORE.</span>
                    </div>
                </footer> --}}
                <!-- partial -->
    ...
    <script>
        ...
        {
          $("#modalInicio").modal("show"); //cada vez que entre a una pagina el modal carga de una
        });
    </script>
    @endif --}}
</body>

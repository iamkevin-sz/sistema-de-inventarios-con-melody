                    ...
                    <div class="table-responsive">
                        <table id="data-tables" class="table">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    <th scope="row"><a href="{{route('proveedores.show', $proveedor)}}">{{$proveedor->id}}</th></a>
                                    ...
                                    {!! Form::open(['route' => ['proveedores.destroy', $proveedor->id], 'method' => 'DELETE']) !!}
                                        ...
                                        <a class="jsgrid-button jsgrid-edit-button" href="{{route('proveedores.edit', $proveedor->id)}}" title="editar"><i class="far fa-edit"></i></a>
                                        ...
                                        <a href="{{route('proveedores.show', $proveedor->id)}}" class="jsgrid-button jsgrid-edit-button"><i class="far fa-eye"></i></a>

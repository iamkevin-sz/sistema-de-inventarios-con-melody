                        ...
                        <div class="row">
                            <div class="col-xs-4 col-sm-4 col-md-4">
                                <div class="form-group">
                                    ...
                                    <input type="text"
                                    class="form-control" name="nombre" id="nombre" aria-describedby="helpId" requerid>
                            ...
                            <div class="col-xs-4 col-sm-4 col-md-4">
                                <div class="form-group">
                                    ...
                                    <input type="number"
                                        class="form-control" name="ci" id="ci" aria-describedby="helpId" requerid>
                            ...
                            <div class="col-xs-4 col-sm-4 col-md-4">
                                <div class="form-group">
                                    ...
                                    <input type="text"
                                        class="form-control" name="direccion" id="direccion" aria-describedby="helpId" >
